            ...
            <div class="col-xl-12">
                        ...
                        <div class="card ">
                            <div class="card-body employee-detail-body fulls-card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Religion')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->religion:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Nationality')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->nationality:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('NID')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->nid:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Passport')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->passport:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Blood Group')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->bg:''); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card ">
                            <div class="card-body employee-detail-body fulls-card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Team Assigned')); ?> :</strong>
                                            <span><?php echo e(!empty($employee->team_id)?$employee->team->name:''); ?> <?php echo e(!empty($employee->team_lead) ? $employee->team_lead == '1' ? '(Team Leader)' : '' : ''); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="card ">
                            <div class="card-body employee-detail-body fulls-card">
                                <h5><?php echo e(__('Family Detail')); ?></h5>
                                <hr>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Father Name')); ?> : </strong>
                                            <span><?php echo e(!empty($employee)?$employee->father_name:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm font-style">
                                            <strong class="font-bold"><?php echo e(__('Father Occupation')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->father_occupation:''); ?></span>
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Mother Name')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->mother_name:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Mother Occupation')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->mother_occupation:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Maritial Status')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->marital_status:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Spouse Name')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->spouse_name:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Spouse Occupation')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->spouse_occupation:''); ?></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="card ">
                            <div class="card-body employee-detail-body fulls-card">
                                <h5><?php echo e(__('Equipment Details')); ?></h5>
                                <hr>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Mobile Name')); ?> : </strong>
                                            <span><?php echo e(!empty($employee)?$employee->mobile_name:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm font-style">
                                            <strong class="font-bold"><?php echo e(__('Date Receive Mobile')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->date_receive_mobile:''); ?></span>
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Sim Card No')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->sim_no:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Date Receive Sim')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->date_receive_sim:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Laptop Name')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->laptop_name:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Product Code')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->product_code:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Date Receive Laptop')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->date_receive_laptop:''); ?></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="card ">
                            <div class="card-body employee-detail-body fulls-card">
                                <h5><?php echo e(__('Emergency Contact Details')); ?></h5>
                                <hr>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Name')); ?> : </strong>
                                            <span><?php echo e(!empty($employee)?$employee->emergency_contact_name:''); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm font-style">
                                            <strong class="font-bold"><?php echo e(__('Mobile')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->emergency_contact_phone:''); ?></span>
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold"><?php echo e(__('Relation')); ?> :</strong>
                                            <span><?php echo e(!empty($employee)?$employee->emergency_contact_relation:''); ?></span>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\erp_demo\resources\views/employee/show.blade.php ENDPATH**/ ?>