...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        function getDepartment(bid) {
            ...
            $.ajax({
                url: '<?php echo e(route('device-attendanceemployee.report.attendance.getdepartment')); ?>',
                type: 'POST',
                data: {
                    "branch_id": bid,
        ...
        function getEmployee(did) {
            $.ajax({
                url: '<?php echo e(route('device-attendanceemployee.report.attendance.getemployee')); ?>',
                type: 'POST',
                data: {
        ...
        <div class="col-xl-12 col-md-12 col-lg-3">
            <div class="card p-4 mb-4">
                <table class="table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $data['employee_causes'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cause): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>

                        <td><?php echo e($key+1); ?></td>
                        <td><?php echo e($cause?->employee->name ?? "N/A"); ?></td>
                        <td><?php echo e($cause->date ?? "N/A"); ?></td>
                        <td><?php echo e($cause->time ?? "N/A"); ?></td>
                        <td><?php echo e($cause->type ?? "N/A"); ?></td>
                        <td><?php echo e($cause->note ?? "N/A"); ?></td>
                      </tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                  </table>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\erp_demo\resources\views/DeviceReport/monthlyAttendance.blade.php ENDPATH**/ ?>