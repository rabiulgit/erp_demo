    ...
    <div class="navbar-content">
        <?php if(\Auth::user()->type != 'client'): ?>
            <ul class="dash-navbar">
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        <?php if($show_dashboard == 1 && Gate::check('show account dashboard')): ?>
                            <li
                                class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == null || Request::segment(1) == 'report' || Request::segment(1) == 'reports-monthly-cashflow' || Request::segment(1) == 'reports-quarterly-cashflow' ? ' active dash-trigger' : ''); ?>">
                                <a class="dash-link" href="#"><?php echo e(__('Accounting ')); ?><span class="dash-arrow"><i
                    ...
                    <?php if(Gate::check('manage employee') || Gate::check('manage setsalary')): ?>
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php if(Gate::check('manage set salary') || Gate::check('manage pay slip')): ?>
                                    <li
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            <li
                                                class="dash-item <?php echo e(request()->is('provident-fund/*') ? 'active' : ''); ?>">
                                                <a class="dash-link"
                                                    href="<?php echo e(route('provident-fund.index')); ?>"><?php echo e(__('Provident Fund')); ?></a>
                                            </li>
                                            <li
                                                class="dash-item <?php echo e(request()->is('provident-fund-interest/*') ? 'active' : ''); ?>">
                                                <a class="dash-link"
                                                    href="<?php echo e(route('provident-fund.interest')); ?>"><?php echo e(__('Provident Interest')); ?></a>
                                            </li>
                                            <li class="dash-item <?php echo e(request()->is('gratuity/*') ? 'active' : ''); ?>">
                                                <a class="dash-link"
                                                    href="<?php echo e(route('gratuity.index')); ?>"><?php echo e(__('Gratuity')); ?></a>
                                            </li>
                                            <li
                                                class="dash-item <?php echo e(request()->is('gratuity-interest/*') ? 'active' : ''); ?>">
                                                <a class="dash-link"
                                                    href="<?php echo e(route('gratuity.interest')); ?>"><?php echo e(__('Gratuity Interest')); ?></a>
                                            </li>
                                ...
                                <?php if( Gate::check('manage device attendance')): ?>
                                    <li
                                        class="dash-item dash-hasmenu  <?php echo e(Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee' ? 'active dash-trigger' : ''); ?>">

                                        <a class="dash-link" href="#"><?php echo e(__('Device Attendance')); ?><span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage device attendance')): ?>
                                                <li
                                                    class="dash-item <?php echo e(Request::route()->getName() == 'device-attendanceemployee' ? 'active' : ''); ?>">
                                                    <a class="dash-link"
                                                        href="<?php echo e(route('device-attendanceemployee.lists')); ?>"><?php echo e(__('Attendance lists')); ?></a>
                                                </li>
                                                <li
                                                    class="dash-item <?php echo e(Request::route()->getName() == 'device-attendanceemployee' ? 'active' : ''); ?>">
                                                    <a class="dash-link"
                                                        href="<?php echo e(route('device-attendanceemployee.report.monthly.attendance')); ?>"><?php echo e(__('Attendance Reports')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                    </li>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage meeting')): ?>
                                    <li class="dash-item <?php echo e(request()->is('meeting*') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                                            href="<?php echo e(route('employee-meetings.index')); ?>"><?php echo e(__('Employee Meeting')); ?></a>
                                    </li>
                                <?php endif; ?>
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php if(Gate::check('manage journal entry')): ?>
                                    <li
                                        class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'journal-entry' ? 'active dash-trigger' : ''); ?>">
                ...
                <?php if(
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage user')): ?>
                                <li
                                    class="dash-item <?php echo e(Request::route()->getName() == 'user.userlog' || Request::segment(1) == 'userlogs' ? ' active' : ''); ?>">
                ...
                <?php if(\Auth::user()->type == 'company'): ?>
                    <li
                        class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'notification-templates' ? 'active' : ''); ?>">
                ...
                <?php if(\Auth::user()->type == 'company'): ?>
                    <li
                        class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'approval-setup' ? ' active' : ''); ?>">
                        <a href="<?php echo e(route('approval.setup')); ?>" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-receipt"></i></span><span
                                class="dash-mtext"><?php echo e(__('Approval Setup')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\erp_demo\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>