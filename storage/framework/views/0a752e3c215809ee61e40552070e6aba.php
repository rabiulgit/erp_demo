...
<nav class="dash-sidebar light-sidebar transprent-bg">
            ...
            <div class="navbar-content">
                ...
                <ul class="dash-navbar">
                        ...
                        <ul class="dash-submenu">
                            ...
                            <li class="dash-item dash-hasmenu  <?php echo e((Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip') ? 'active dash-trigger' : ''); ?>">
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <li class="dash-item <?php echo e(request()->is('provident-fund/*') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                                            href="<?php echo e(route('provident-fund.index')); ?>"><?php echo e(__('Provident Fund')); ?></a>
                                    </li>
                                    <li class="dash-item <?php echo e(request()->is('provident-fund-interest/*') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                                    ...
                                    <li class="dash-item <?php echo e(request()->is('gratuity-interest/*') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                    ...
                    <li
                        ...
                        <a class="dash-link"
                            href="#"><?php echo e(__('Leave Management Setup')); ?><span
                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                           ...
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage attendance')): ?>
                            <li
                                ...
                                <a class="dash-link"
                                    href="<?php echo e(route('device-attendanceemployee.lists')); ?>"><?php echo e(__('Device Attendance')); ?></a>
                            </li>
                            <li
                                class="dash-item <?php echo e(Request::route()->getName() == 'device-attendanceemployee' ? 'active' : ''); ?>">
                                <a class="dash-link"
                                    href="<?php echo e(route('device-attendanceemployee.report.monthly.attendance')); ?>"><?php echo e(__('Device Reports')); ?></a>
                            </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage attendance')): ?>
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        ...
                        <li
                            ...
                            <a class="dash-link"
                                href="<?php echo e(route('user.userlog')); ?>"><?php echo e(__('User Logs')); ?></a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <?php if(\Auth::user()->type == "company"): ?>
                <li class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'approval-setup' ? ' active' : ''); ?>">
    ...
    </nav><?php /**PATH C:\laragon\www\erp_demo\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>