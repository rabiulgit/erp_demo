                    ...
                    <div class="col-xxl-6">
                      ...
                      <div class="card">
                            <div class="card-header">
                                <h4><?php echo e(__('Device Attendance Status')); ?></h4>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <div class="info text-md">
                                                <strong class="font-bold"><?php echo e(__('Status')); ?> : </strong>
                                                <span style="background-color: green; color: white; padding: 5px; border-radius: 5px; border: none;" class="text-md"><?php echo e($attendance->status); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info text-md">
                                                <strong class="font-bold"><?php echo e(__('Clock In')); ?> : </strong>
                                                <span><?php echo e($attendance->clock_in); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info text-md">
                                                <strong class="font-bold"><?php echo e(__('Clock Out')); ?> : </strong>
                                                <span><?php echo e($attendance->clock_out); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info text-md">
                                                <strong class="font-bold"><?php echo e(__('Late')); ?> : </strong>
                                                <span><?php echo e($attendance->late); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info text-md">
                                                <strong class="font-bold"><?php echo e(__('Early Leave')); ?> : </strong>
                                                <span><?php echo e($attendance->early_leaving); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info text-md">
                                                <strong class="font-bold"><?php echo e(__('Overtime')); ?> : </strong>
                                                <span><?php echo e($attendance->overtime); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                <?php else: ?>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="info text-lg">
                                            <strong class="font-bold"><?php echo e(__('Status')); ?> : </strong>
                                            <span style="background-color: red; color: white; padding: 5px; border-radius: 5px; border: none;" class="text-md"><?php echo e($attendance->status); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <?php endif; ?>
                            ...
                            <div class="col-md-12">
                                <div class="row g-3 flex-nowrap team-lists horizontal-scroll-cards">
                                    <?php $__currentLoopData = $notClockIns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notClockIn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-auto">
                                            <img src="<?php echo e(!empty($notClockIn->user) ? $notClockIn->user->profile : asset(Storage::url('uploads/avatar/avatar.png'))); ?>"
                                                alt="">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="d-flex align-items-start mb-3">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-success"><?php echo e($onGoingTraining + $doneTraining); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\erp_demo\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>