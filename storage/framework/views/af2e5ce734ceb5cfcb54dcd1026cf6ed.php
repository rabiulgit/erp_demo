    ...
    <div class="footer-wrapper d-flex justify-content-center">
        <div class="py-1">
            <p class="mb-0 text-muted"> &copy;
                <?php echo e(date('Y')); ?> <?php echo e(Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'ERPGo')); ?> 2024 | All Rights Reserved.
            </p>
        </div>
...
<?php /**PATH C:\laragon\www\erp_demo\resources\views/partials/admin/footer.blade.php ENDPATH**/ ?>