                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(!empty($leave->attachment)): ?>
                                            <a href="<?php echo e(url('storage/leave/'.$leave->attachment)); ?>" class="btn btn-primary btn-sm" download>
                                                Download
                                            </a>
                                        <?php else: ?>
                                            -
                                    ...
                                    <td>
                                        <div class="action-btn bg-warning ms-2">
                                            <a href="#" data-url="<?php echo e(URL::to('leave/'.$leave->id.'/action')); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('View Leave')); ?>" class="mx-3 btn btn-sm  align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('View Leave')); ?>" data-original-title="<?php echo e(__('View Leave')); ?>">
                                        ...
                                        <?php if($isAdmin == 1): ?>
                                            <?php if($leave->statusChecked == 0): ?>
                                                <div class="action-btn bg-success ms-2">
                                                    <a href="<?php echo e(route('leave.approve', $leave->id)); ?>"
                                                ...
                                                <div class="action-btn bg-danger ms-2">
                                                    <a href="<?php echo e(route('leave.reject', $leave->id)); ?>"
                                                        class="btn btn-sm">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\erp_demo\resources\views/leave/index.blade.php ENDPATH**/ ?>