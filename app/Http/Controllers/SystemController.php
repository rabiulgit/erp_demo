...
//            $ip = $_SERVER['REMOTE_ADDR'];
    ...
    //for PF setting
    public function savePfSettings(Request $request)
    {

        foreach ($request->all() as $key => $value) {
            if($key != '_token'){
                $data = Utility::whereName($key)->first();
        ...
        return redirect()->back()->with('success', __('Provident Fund settings successfully updated.'));
    }

    //for Gratuity setting
    public function saveGratuitySettings(Request $request)
    {
        ...
        return redirect()->back()->with('success', __('Gratuity settings successfully updated.'));
    }

    public function saveTaxSettings(Request $request)
    {
        $tax_calculation = $request->has('tax_calculation') ? $request->tax_calculation : 'off';

        Utility::whereName('tax_calculation')->first()->update([
        ...
        return redirect()->back()->with('success', __('Tax settings successfully updated.'));
    }
