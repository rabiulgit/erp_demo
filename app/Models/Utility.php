...
public static function vats($vat)
{
    if(self::$vats == null)
    {
        $vat = Vat::find($vat);
...
private static $vatData = NULL;

public static function vat($vats)
{
...
public static function vatRate($vatRate, $price, $quantity, $discount = 0)
{
    return (($price * $quantity) - $discount) * ($vatRate / 100);
}

private static $vatRateData =  NULL;

public static function totalVatRate($vats)
{
    if(self::$vatRateData == null)
    {
        $vatArr  = explode(',', $vats);
        $vatRate = 0;
        ...
        {
            $vat     = self::vats($vat);
            $vatRate += !empty($vat->rate) ? $vat->rate : 0;
        }

        self::$vatRateData = $vatRate;
    }
    return self::$vatRateData;
}
