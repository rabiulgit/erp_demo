...
class Employee extends Model
{
    ...
    public function allowanceCommisions()
    {
        ...
        return $total_allowance + $total_commission;
    }

    public function overtimeOthers()
    {
        ...
        return $total_other_payment + $total_over_time;
    }
    ...
    public function get_net_salary()
    {
        ...
        $net_salary = $this->salary + $this->bonus + $total_allowance + $total_commission - $total_loan - $total_saturation_deduction + $total_other_payment + $total_over_time;
