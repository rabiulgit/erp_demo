...
class Lead extends Model
{
    ...
    public function leadMoms()
    {
        return $this->hasMany(LeadMom::class, 'lead_id');
    }

    public function leadCads()
    {
        return $this->hasMany(LeadCad::class, 'lead_id');
    }

    public function leadBoqs()
    {
        return $this->hasMany(LeadBoq::class, 'lead_id');
    }

    public function leadPrices()
    {
        return $this->hasMany(LeadPrice::class, 'lead_id');
    }

    public function leadSurveys()
    {
        return $this->hasMany(LeadSurvey::class, 'lead_id');
    }
}
