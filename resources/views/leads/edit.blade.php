    ...
    <div class="row">
        ...
        <div class="col-6 form-group">
            ...
            @if (\Auth::user()->type== 'Marketing')
                {{ Form::select('user_id', $users,null, array('class' => 'form-control select','required'=>'required','disabled'=>'disabled')) }}
        ...
        <div class="col-12 form-group" style="z-index: 1000">
        ...
        <div class="col-12 form-group" style="z-index: 999">
