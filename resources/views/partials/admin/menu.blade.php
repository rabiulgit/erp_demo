    ...
    <nav class="dash-sidebar light-sidebar">
        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content">
                        ...
                        <ul class="dash-submenu">
                            ...
                            <li class="dash-item dash-hasmenu  {{ (Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip') ? 'active dash-trigger' : ''}}">
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <li class="dash-item {{ request()->is('provident-fund/*') ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('provident-fund.index') }}">{{ __('Provident Fund') }}</a>
                                    </li>
                                    <li class="dash-item {{ request()->is('provident-fund-interest/*') ? 'active' : '' }}">
                                        <a class="dash-link"
                                    ...
                                    <li class="dash-item {{ request()->is('gratuity-interest/*') ? 'active' : '' }}">
                                        <a class="dash-link"
                        ...
                        <ul class="dash-submenu">
                           ...
                           @can('manage attendance')
                            <li
                                ...
                                <a class="dash-link"
                                    href="{{ route('device-attendanceemployee.lists') }}">{{ __('Device Attendance') }}</a>
                            </li>
                            <li
                                class="dash-item {{ Request::route()->getName() == 'device-attendanceemployee' ? 'active' : '' }}">
                                <a class="dash-link"
                                    href="{{ route('device-attendanceemployee.report.monthly.attendance') }}">{{ __('Device Reports') }}</a>
                            </li>
                            @endcan
                            @can('manage attendance')
                ...
                @if (\Auth::user()->type == "company")
                <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'approval-setup' ? ' active' : '' }}">
