    ...
    <div class="navbar-content">
        @if (\Auth::user()->type != 'client')
            <ul class="dash-navbar">
                    ...
                    @if (Gate::check('manage employee') || Gate::check('manage setsalary'))
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                <li class="dash-item ">
                                    <a class="dash-link"
                                        href="{{ route('employee-causes.index') }}">{{ __('Employee cause') }}</a>
                                </li>
                                @if (Gate::check('manage set salary') || Gate::check('manage pay slip'))
                                    <li
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            <li
                                                class="dash-item {{ request()->is('provident-fund/*') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                    href="{{ route('provident-fund.index') }}">{{ __('Provident Fund') }}</a>
                                            </li>
                                            <li
                                                class="dash-item {{ request()->is('provident-fund-interest/*') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                    href="{{ route('provident-fund.interest') }}">{{ __('Provident Interest') }}</a>
                                            </li>
                                            <li class="dash-item {{ request()->is('gratuity/*') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                    href="{{ route('gratuity.index') }}">{{ __('Gratuity') }}</a>
                                            </li>
                                            <li
                                                class="dash-item {{ request()->is('gratuity-interest/*') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                    href="{{ route('gratuity.interest') }}">{{ __('Gratuity Interest') }}</a>
                                            </li>
                                            {{-- <li class="dash-item {{ request()->is('tax/report/*') ? 'active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('tax.report') }}">{{ __('Tax') }}</a>
                            </li> --}}
                                        </ul>
                                    </li>
                                @endif
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            @can('manage device attendance')
                                                <li
                                                    ...
                                                    <a class="dash-link"
                                                        href="{{ route('device-attendanceemployee.lists') }}">{{ __('Attendance lists') }}</a>
                                                </li>
                                                <li
                                                    class="dash-item {{ Request::route()->getName() == 'device-attendanceemployee' ? 'active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ route('device-attendanceemployee.report.monthly.attendance') }}">{{ __('Attendance Reports') }}</a>
                                                </li>
                                            @endcan
                                        </ul>
                                    </li>
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                @if (Gate::check('manage journal entry'))
                                    <li
                                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'journal-entry' ? 'active dash-trigger' : '' }}">
                ...
                @if (
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            ...
                            @can('manage user')
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'user.userlog' || Request::segment(1) == 'userlogs' ? ' active' : '' }}">
                ...
                @if (\Auth::user()->type == 'company')
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'approval-setup' ? ' active' : '' }}">
                        <a href="{{ route('approval.setup') }}" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-receipt"></i></span><span
                                class="dash-mtext">{{ __('Approval Setup') }}</span>
                        </a>
                    </li>
                @endif
