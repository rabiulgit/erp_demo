<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{route('vats.index')}}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'vats.index' ) ? ' active' : '' }}">{{__('Vats')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>    
