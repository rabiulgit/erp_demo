<div class="card-body">
        ...
        <div class="tab-pane fade show active" id="item" role="tabpanel" aria-labelledby="profile-tab3">
            <div class="timeline d-flex align-items-center flex-column">
                ...
                @foreach ($approvals as $approval)
                    @if ($approval->module === 'payroll')
                        <div class="timeline-item">
                            <div class="timeline-content">
                                <h5 class="mb-0">Layer {{ $levelCounter }} - {{ $approval->role->name }}</h5>
                            </div>
                            <div class="actions">
                                <a href="{{ route('payroll.approval.delete', $approval->id) }}"
    ...
    <div class="timeline-item justify-content-center">
        <button class="btn btn-primary btn-sm" id="addStepBtn" data-bs-toggle="modal" data-bs-target="#payrollModal">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="payrollModalLabel">Select Role
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('payroll.approval.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
