                    ...
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#company-settings" class="list-group-item list-group-item-action border-0">{{ __('Company Settings') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            <a href="#pf-settings" class="list-group-item list-group-item-action border-0">{{ __('Provident Fund Settings') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            <a href="#gratuity-settings" class="list-group-item list-group-item-action border-0">{{ __('Gratuity Settings') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            {{-- <a href="#tax-settings" class="list-group-item list-group-item-action border-0">{{ __('Tax Settings') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div></a> --}}
...
{{--                                </div>--}}
                    ...
                    <div id="pf-settings" class="card">
                        <div class="card-header">
                            <h5>{{ __('Provident Fund Settings') }}</h5>
                            <small class="text-muted">{{ __('Edit your provident fund details') }}</small>
                        </div>
                        {{ Form::model($settings, ['route' => 'pf.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                                <h5 class="mb-3">{{ __('Organization Provident') }}</h5>
                                <div class="form-group col-md-6">
                                    {{ Form::label('organization_provident_type', __('Provident Type *'), ['class' => 'form-label']) }}

                                    <select name="organization_provident_type" id="organization_provident_type"
                                        class="form-control select">
                                        <option value="fixed"
                                            {{ $settings['organization_provident_type'] == 'fixed' ? 'selected' : '' }}>
                                            Fixed</option>
                                        <option value="percentage"
                                            {{ $settings['organization_provident_type'] == 'percentage' ? 'selected' : '' }}>
                                            Percentage</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('organization_provident_value', __('Provident Value *'), ['class' => 'form-label']) }}
                                    {{ Form::text('organization_provident_value', isset($settings['organization_provident_value']) ? $settings['organization_provident_value'] : '0', ['class' => 'form-control']) }}
                                </div>
                            </div>

                            <div class="row">
                                <h5 class="mb-3">{{ __('Own Provident') }}</h5>
                                <div class="form-group col-md-6">
                                    {{ Form::label('own_provident_type', __('Provident Type *'), ['class' => 'form-label']) }}

                                    <select name="own_provident_type" id="own_provident_type"
                                        class="form-control select">
                                        <option value="fixed"
                                            {{ $settings['own_provident_type'] == 'fixed' ? 'selected' : '' }}>Fixed
                                        </option>
                                        <option value="percentage"
                                            {{ $settings['own_provident_type'] == 'percentage' ? 'selected' : '' }}>
                                            Percentage</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('own_provident_value', __('Provident Value *'), ['class' => 'form-label']) }}
                                    {{ Form::text('own_provident_value', isset($settings['own_provident_value']) ? $settings['own_provident_value'] : '0', ['class' => 'form-control']) }}
                                </div>
                            </div>

                            <div class="row">
                                <h5 class="mb-3">{{ __('Provident Interest') }}</h5>
                                <div class="form-group col-md-6">
                                    {{ Form::label('provident_interest_type', __('Interest Type *'), ['class' => 'form-label']) }}

                                    <select name="provident_interest_type" id="provident_interest_type"
                                        class="form-control select">
                                        <option value="fixed"
                                            {{ $settings['provident_interest_type'] == 'fixed' ? 'selected' : '' }}>Fixed
                                        </option>
                                        <option value="percentage"
                                            {{ $settings['provident_interest_type'] == 'percentage' ? 'selected' : '' }}>
                                            Percentage</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('provident_interest_value', __('Interest Value *'), ['class' => 'form-label']) }}
                                    {{ Form::text('provident_interest_value', isset($settings['provident_interest_value']) ? $settings['provident_interest_value'] : '0', ['class' => 'form-control']) }}
                    ...
                    <!--Gratuity Settings-->
                    <div id="gratuity-settings" class="card">
                        <div class="card-header">
                            <h5>{{ __('Gratuity Settings') }}</h5>
                            <small class="text-muted">{{ __('Edit your gratuity details') }}</small>
                        </div>
                        {{ Form::model($settings, ['route' => 'gratuity.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                                <h5 class="mb-3">{{ __('Employee Gratuity') }}</h5>
                                <div class="form-group col-md-6">
                                    {{ Form::label('organization_provident_type', __('Gratuity Type *'), ['class' => 'form-label']) }}

                                    <select name="gratuity_type" id="gratuity_type" class="form-control select">
                                        <option value="fixed"
                                            {{ $settings['gratuity_type'] == 'fixed' ? 'selected' : '' }}>Fixed</option>
                                        <option value="percentage"
                                            {{ $settings['gratuity_type'] == 'percentage' ? 'selected' : '' }}>Percentage
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('gratuity_value', __('Gratuity Value *'), ['class' => 'form-label']) }}
                                    {{ Form::text('gratuity_value', isset($settings['gratuity_value']) ? $settings['gratuity_value'] : '0', ['class' => 'form-control']) }}
                                </div>
                            </div>

                            <div class="row">
                                <h5 class="mb-3">{{ __('Gratuity Interest') }}</h5>
                                <div class="form-group col-md-6">
                                    {{ Form::label('gratuity_interest_type', __('Interest Type *'), ['class' => 'form-label']) }}

                                    <select name="gratuity_interest_type" id="gratuity_interest_type"
                                        class="form-control select">
                                        <option value="fixed"
                                            {{ $settings['gratuity_interest_type'] == 'fixed' ? 'selected' : '' }}>Fixed
                                        </option>
                                        <option value="percentage"
                                            {{ $settings['gratuity_interest_type'] == 'percentage' ? 'selected' : '' }}>
                                            Percentage</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('gratuity_interest_value', __('Interest Value *'), ['class' => 'form-label']) }}
                                    {{ Form::text('gratuity_interest_value', isset($settings['gratuity_interest_value']) ? $settings['gratuity_interest_value'] : '0', ['class' => 'form-control']) }}
                    ...
                    <!--Tax Settings-->
                    <div id="tax-settings" class="card">
                        <div class="card-header">
                            <h5>{{ __('Tax Settings') }}</h5>
                            <small class="text-muted">{{ __('Edit your tax details') }}</small>
                        </div>
                        {{ Form::model($settings, ['route' => 'tax.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                                <h6 class="mb-3">{{ __('Enable Tax Calculation') }}</h6>
                                <div class="form-group col-md-6">
                                    <input type="checkbox" name="tax_calculation"
                                        data-toggle="switchbutton"
                                        {{ $settings['tax_calculation'] == 'on' ? 'checked="checked"' : '' }}
