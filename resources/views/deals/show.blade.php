                            ...
                            <div class="card">
                                <div class="row card-body">
                                    <div class="col-12 mb-2">
                                        <h5 class="text-primary text-center">Client Details</h5>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row mb-1">
                                            <div class="col-4"><b>Name:</b></div>
                                            <div class="col-8">{{ optional($dealDetails)->client_name ?? '-' }}</div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-4"><b>Email:</b></div>
                                            <div class="col-8">{{ optional($dealDetails)->email ?? '-' }}</div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-4"><b>Phone:</b></div>
                                            <div class="col-8">{{ optional($dealDetails)->phone ?? '-' }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row mb-1">
                                            <div class="col-4"><b>Reference No:</b></div>
                                            <div class="col-8">{{ optional($deal)->reference ?? '-' }}</div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-4"><b>Address:</b></div>
                                            <div class="col-8">{{ optional($dealDetails)->address ?? '-' }}</div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-4"><b>Informations:</b></div>
                                            <div class="col-8">{!! optional($dealDetails)->informations ? html_entity_decode($dealDetails->informations) : '-' !!}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
