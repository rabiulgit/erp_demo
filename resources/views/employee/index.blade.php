...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="{{ route('employee.export') }}" data-bs-toggle="tooltip" title="{{ __('Export CSV') }}"
            class="btn btn-sm btn-primary">
            <i class="ti ti-file-export"></i>
        </a>
        <a href="{{ route('employee.exportPDF') }}" data-bs-toggle="tooltip" title="{{ __('Export PDF') }}"
            class="btn btn-sm btn-primary">
                                ...
                                @foreach ($employees as $employee)
                                    <tr>
                                        ...
                                        @if ($employee->branch_id)
                                            <td class="font-style">
                                                {{ !empty($employee->branch) ? $employee->branch->name : '' }}</td>
                                        @else
                                            <td>-</td>
                                        @endif
                                        @if ($employee->department_id)
                                            <td class="font-style">
                                                {{ !empty($employee->department) ? $employee->department->name : '' }}</td>
                                        @else
                                            <td>-</td>
                                        @endif
                                        @if ($employee->designation_id)
                                            <td class="font-style">
                                                {{ !empty($employee->designation) ? $employee->designation->name : '' }}</td>
                                        @else
                                            <td>-</td>
                                        @endif
