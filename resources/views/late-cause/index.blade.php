...
@section('page-title')
    {{ __('Manage lateCauses') }}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item">{{ __('lateCauses') }}</li>
@endsection

@section('action-btn')
    <div class="float-end">

        <a href="#" data-url="{{ route('employee-late-causes.create') }}" data-size="lg" data-ajax-popup="true"
            data-title="{{ __('Create New lateCauses') }}" data-bs-toggle="tooltip" title="{{ __('Create lateCauses') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-btn bg-primary ms-2">
                                                <a href="#"
                                                    data-url="{{ URL::to('employee-late-causes/' . $row->id . '/edit') }}"
                                                    data-size="lg" data-ajax-popup="true"
                                                    data-title="{{ __('Edit lateCauses') }}"
                                            ...
                                            <div class="action-btn bg-danger ms-2">
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'route' => ['employee-late-causes.destroy', $row->id],
