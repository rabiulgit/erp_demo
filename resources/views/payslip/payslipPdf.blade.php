                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-md">
                                    ...
                                    @if($showBonus)
                                    <tr>
                                        <td>{{__('Festival Bonus')}}</td>
                                        <td>-</td>
                                        <td class="text-end">{{  \Auth::user()->priceFormat( $employee->bonus)}}</td>
                                    </tr>
                                    @endif
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-4 text-end">
                                    ...
                                    <div class="invoice-detail-item">
                                        <div class="invoice-detail-name font-bold">{{__('Provident Fund')}}</div>
                                        <div class="invoice-detail-value">{{\Auth::user()->priceFormat($payslip->provident_fund) }}</div>
                                    </div>
                                    {{-- <div class="invoice-detail-item">
                                        <div class="invoice-detail-name font-bold">{{__('Tax')}}</div>
                                        <div class="invoice-detail-value">{{\Auth::user()->priceFormat($payslip->tax) }}</div>
                                    </div> --}}
                                    <hr class="mt-2 mb-2">
                                    <div class="invoice-detail-item">
