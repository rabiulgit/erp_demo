...
<div class="col-form-label">
    <div class="row px-3">
        <div class="col-md-3 mb-3">
            ...
            <h6 class="emp-title black-text">{{  !empty($payslip->employees) ? $payslip->employees->employee_id:''}}</h6>
        </div>
        <div class="col-md-3 mb-3">
        ...
        <div class="col-md-3 mb-3">
            <h6 class="emp-title mb-0">{{__('Festival Bonus')}}</h6>
            <h6 class="emp-title black-text">{{  \Auth::user()->priceFormat( $bonus)}}</h6>
        </div>
        <div class="col-md-3 mb-3">
