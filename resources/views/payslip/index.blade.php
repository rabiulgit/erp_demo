            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    <div class="col-auto float-end ms-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary" data-bs-toggle="tooltip" title="{{ __('payslip') }}" data-original-title="{{ __('payslip') }}">
                            {{ __('Generate Payslip') }}
                         </button>
                    ...
                    <div class="col-md-8">
                        <div class="d-flex align-items-center justify-content-end ">
                            ...
                            <div class="col-auto float-end me-2">
                                ...
                                <input type="submit" value="{{ __('Export CSV') }}" class="btn btn-primary">
                                {{ Form::close() }}
                            </div>
                            <div class="col-auto float-end me-2">
                                {{ Form::open(['route' => ['payslip.exportPDF'], 'method' => 'POST', 'id' => 'payslip_form']) }}
                                <input type="hidden" name="filter_month" class="filter_month">
                                <input type="hidden" name="filter_year" class="filter_year">
                                <input type="submit" value="{{ __('Salary Sheet PDF') }}" class="btn btn-primary">
                                {{ Form::close() }}
                            </div>
