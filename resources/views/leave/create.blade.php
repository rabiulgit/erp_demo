        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::select('employee_id', $employees, null, ['class' => 'form-control select', 'id' => 'employee_id', 'placeholder' => __('Select Employee'), 'required' => 'required']) }}
                </div>
            </div>
        </div>
    @endif
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('leave_reason', null, ['class' => 'form-control', 'placeholder' => __('Leave Reason'), 'required' => 'required']) }}
            </div>
        </div>
    </div>
    <div class="row">
...
@php
    $employee_id = \App\Models\Employee::where('user_id', auth()->user()->id)->value('id');
@endphp
