                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <div class="info text-md">
                                                ...
                                                <span style="background-color: green; color: white; padding: 5px; border-radius: 5px; border: none;" class="text-md">{{$attendance->status}}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info text-md">
                                                <strong class="font-bold">{{__('Clock In')}} : </strong>
                                                <span>{{$attendance->clock_in}}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info text-md">
                                                <strong class="font-bold">{{__('Clock Out')}} : </strong>
                                                <span>{{$attendance->clock_out}}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info text-md">
                                                <strong class="font-bold">{{__('Late')}} : </strong>
                                                <span>{{$attendance->late}}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info text-md">
                                                <strong class="font-bold">{{__('Early Leave')}} : </strong>
                                                <span>{{$attendance->early_leaving}}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info text-md">
                                                <strong class="font-bold">{{__('Overtime')}} : </strong>
                        ...
                        @if ($holidays)
                            <div class="card">
                                ...
                                <div class="card-body dash-card-body">
                                    ...
                                    <center>
                                        {{-- <div class="row">
                                        <h3>Today is <span class="text-danger">{{$holidays->occasion}}</span></h3>
                                    </div> --}}
                                                ...
                                                @if ($holidays->count() > 1)
                                                    @foreach ($holidays as $index => $holiday)
                                                        @if ($index == $holidays->count() - 1)
                                                            and <span class="text-danger">{{ $holiday->occasion }}</span>
                                                        @elseif($index == $holidays->count() - 2)
                                                            <span class="text-danger">{{ $holiday->occasion }}</span>
                                                        @else
                                                            <span class="text-danger">{{ $holiday->occasion }}</span>,
                                                        @endif
                                                    @endforeach
                                                @else
                                                    <span class="text-danger">{{ $holidays->first()->occasion }}</span>
                                                @endif
                                            </h3>
                                        </div> --}}
