...
use App\Http\Controllers\ProvidentFund;
...
use App\Http\Controllers\ApprovalSetup;
...
Route::group(
    ...
    function () {
        ...
        Route::post('pf-settings', [SystemController::class, 'savePfSettings'])->name('pf.settings');
        Route::post('gratuity-settings', [SystemController::class, 'saveGratuitySettings'])->name('gratuity.settings');
        Route::post('tax-settings', [SystemController::class, 'saveTaxSettings'])->name('tax.settings');
...
Route::group(
    ...
    function () {
        ...
        //     $token = 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhbGluIiwiZXhwIjoxNzA5NDEyNTAwLCJpYXQiOjE3MDkzNzY1MDB9.4ewaN8chWm43LoHI_Hmi1eyersu0gjiYGBquD9Pulls';

        //     $response = Http::withHeaders([
        //         'Authorization' => 'Bearer ' . $token,
        //     ])->get('http://192.168.2.71:8080/api/v1/integrate/search-by-parent?parentAutoAcNo=10004&companyNo=102');

        //     $data = $response->json(); // Extract JSON data from the response

        //     // Assuming your data key is 'accHeadDetailsInfos'
        //     $dropdownData = $data['accHeadDetailsInfos'];

        //     // return view('dropdown', compact('dropdownData'));
        //     return view('customer.create', compact('dropdownData'));
        // });
        # A #
    }
);
# ---
// this is for testing no worries
...
# This part is for banking section, second dropdown
// use Illuminate\Support\Facades\Http; // use this in the head

Route::get('/fetch-second-dropdown', function () {
    $parentAutoAcNo = request('parentAutoAcNo');
    ...
    $response = Http::withHeaders([
        'Authorization' => 'Bearer ' . $token,
    ])->get($api_ip . '/api/v1/integrate/search-by-parent?parentAutoAcNo=' . $parentAutoAcNo . '&companyNo=' . $companyNo);

    $data = $response->json();

    return $data;
})->name('fetch-second-dropdown');
...
# custom added #
Route::resource('vats', VatController::class)->middleware(['auth', 'XSS', 'revalidate']);
# custom added #
...
Route::get('deal/approve/{id}', [DealController::class, 'approveDeal'])->middleware(['auth', 'XSS'])->name('deal.approve');
Route::get('deal/reject/{id}', [DealController::class, 'rejectDeal'])->middleware(['auth', 'XSS'])->name('deal.reject');
// end Deal Module
...
Route::get('/leads/{id}/po-wo', [LeadController::class, 'powos'])->name('leads.powo')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/po-wo', [LeadController::class, 'poWoStore'])->name('leads.powo.store')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/users', [LeadController::class, 'userEdit'])->name('leads.users.edit')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/mom', [LeadController::class, 'userMom'])->name('leads.mom.create')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/survey', [LeadController::class, 'surveyChecklist'])->name('leads.survey.checklist')->middleware(['auth', 'XSS']);
Route::get('/leads/survey/{id}', [LeadController::class, 'addChecklistReport'])->name('leads.checklist.add')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/cad', [LeadController::class, 'userCad'])->name('leads.cad.create')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/boq', [LeadController::class, 'userBoq'])->name('leads.boq.create')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/price', [LeadController::class, 'reqPrice'])->name('leads.price.create')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/price/create', [LeadController::class, 'reqPriceCreate'])->name('leads.price.procurement')->middleware(['auth', 'XSS']);
Route::get('/leads/mom/show/{id}', [LeadController::class, 'userMomShow'])->name('leads.mom.show')->middleware(['auth', 'XSS']);
Route::get('/leads/surveyReport/show/{id}', [LeadController::class, 'showSurveyReport'])->name('leads.surveyReport.show')->middleware(['auth', 'XSS']);
Route::put('/leads/{id}/users', [LeadController::class, 'userUpdate'])->name('leads.users.update')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/mom', [LeadController::class, 'storeMom'])->name('leads.mom.store')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/checklist', [LeadController::class, 'storeChecklist'])->name('leads.checklist.store')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/cad', [LeadController::class, 'storeCad'])->name('leads.cad.store')->middleware(['auth', 'XSS']);
Route::post('/leads/checklistReport/{id}', [LeadController::class, 'storeChecklistReport'])->name('leads.checklistReport.store')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/price', [LeadController::class, 'storeReqPrice'])->name('leads.price.store')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/procurementPrice', [LeadController::class, 'storeProcurementPrice'])->name('leads.procurementPrice.store')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/boq', [LeadController::class, 'storeBoq'])->name('leads.boq.store')->middleware(['auth', 'XSS']);
Route::delete('/leads/mom/{id}', [LeadController::class, 'momDestroy'])->name('leads.mom.destroy')->middleware(['auth', 'XSS']);
...
Route::resource('team', TeamController::class)->middleware(['auth', 'XSS']);
...
Route::get('employee/salarybonus/{eid}', [SetSalaryController::class, 'employeeSalaryBonus'])->name('employee.salary.bonus')->middleware(['auth', 'XSS']);
...
Route::post('employee/update/salarybonus/{id}', [SetSalaryController::class, 'employeeUpdateSalaryBonus'])->name('employee.salarybonus.update')->middleware(['auth', 'XSS']);
...
Route::post('payslip/bulkpayment/{date}/{cash_val}', [PaySlipController::class, 'bulkpayment'])->name('payslip.bulkpayment')->middleware(['auth', 'XSS']);
...
Route::get('provident/payroll', [ReportController::class, 'ProvidentReportExport'])->name('provident.export');
Route::get('gratuity/payroll', [ReportController::class, 'GratuityReportExport'])->name('gratuity.export');
...
//API Test
//Route::get('getAPIAccess', [PaySlipController::class, 'getAPIAccess'])->name('get.api.access')->middleware(['auth', 'XSS']);
//Route::get('getAccount/{type}', [PaySlipController::class, 'getAccount'])->name('get.account')->middleware(['auth', 'XSS']);

//PF
Route::get('provident-fund', [ProvidentFund::class, 'providentFunds'])->middleware(['auth', 'XSS', 'revalidate'])->name('provident-fund.index');
Route::get('provident-fund/{id}', [ProvidentFund::class, 'employeeProvidentFund'])->middleware(['auth', 'XSS', 'revalidate'])->name('provident-fund.employee');
Route::get('provident-fund-interest', [ProvidentFund::class, 'providentFundInterests'])->middleware(['auth', 'XSS', 'revalidate'])->name('provident-fund.interest');
Route::get('provident-fund-interest/{id}', [ProvidentFund::class, 'providentFundEmployeeInterests'])->middleware(['auth', 'XSS', 'revalidate'])->name('provident-fund.employeeInterest');

Route::get('gratuity', [ProvidentFund::class, 'gratuity'])->middleware(['auth', 'XSS', 'revalidate'])->name('gratuity.index');
Route::get('gratuity/{id}', [ProvidentFund::class, 'employeeGratuity'])->middleware(['auth', 'XSS', 'revalidate'])->name('gratuity.employee');
Route::get('gratuity-interest', [ProvidentFund::class, 'gratuityInterest'])->middleware(['auth', 'XSS', 'revalidate'])->name('gratuity.interest');
Route::get('tax/report', [ProvidentFund::class, 'taxReport'])->middleware(['auth', 'XSS', 'revalidate'])->name('tax.report');
Route::get('gratuity-interest/{id}', [ProvidentFund::class, 'gratuityEmployeeInterest'])->middleware(['auth', 'XSS', 'revalidate'])->name('gratuity.employeeInterest');

// Lookup controlling

Route::get('lookup/lookupIndex', [LookupController::class, 'lookupIndex'])->name('lookupIndex');
Route::get('lookup/lookupCreate', [LookupController::class, 'lookupCreate'])->name('lookupCreate');
Route::post('lookup/lookupStore', [LookupController::class, 'lookupStore'])->name('lookupStore');

Route::get('approval-setup', [ApprovalSetup::class, 'index'])->name('approval.setup');

Route::post('leave-approval-store', [ApprovalSetup::class, 'leaveApprovalStore'])->name('leave.approval.store');
Route::get('leave-approval-delete/{id}', [ApprovalSetup::class, 'leaveApprovalDelete'])->name('leave.approval.delete');
...
Route::post('recruitment-approval-store', [ApprovalSetup::class, 'recruitmentApprovalStore'])->name('recruitment.approval.store');
Route::get('recruitment-approval-delete/{id}', [ApprovalSetup::class, 'recruitmentApprovalDelete'])->name('recruitment.approval.delete');

Route::get('job/approve/{id}', [JobController::class, 'approveJob'])->name('job.approve');
Route::get('job/reject/{id}', [JobController::class, 'rejectJob'])->name('job.reject');

Route::post('promotion-approval-store', [ApprovalSetup::class, 'promotionApprovalStore'])->name('promotion.approval.store');
Route::get('promotion-approval-delete/{id}', [ApprovalSetup::class, 'promotionApprovalDelete'])->name('promotion.approval.delete');

Route::get('promotion/approve/{id}', [PromotionController::class, 'approvePromotion'])->name('promotion.approve');
Route::get('promotion/reject/{id}', [PromotionController::class, 'rejectPromotion'])->name('promotion.reject');

Route::post('termination-approval-store', [ApprovalSetup::class, 'terminationApprovalStore'])->name('termination.approval.store');
Route::get('termination-approval-delete/{id}', [ApprovalSetup::class, 'terminationApprovalDelete'])->name('termination.approval.delete');

Route::get('termination/approve/{id}', [TerminationController::class, 'approveTermination'])->name('termination.approve');
Route::get('termination/reject/{id}', [TerminationController::class, 'rejectTermination'])->name('termination.reject');

Route::post('payroll-approval-store', [ApprovalSetup::class, 'payrollApprovalStore'])->name('payroll.approval.store');
Route::get('payroll-approval-delete/{id}', [ApprovalSetup::class, 'payrollApprovalDelete'])->name('payroll.approval.delete');

Route::get('payroll/approve/{id}', [PayslipController::class, 'approvePayroll'])->name('payroll.approve');
Route::get('payroll/reject/{id}', [PayslipController::class, 'rejectPayroll'])->name('payroll.reject');

Route::post('export/payslip-pdf', [PaySlipController::class, 'exportPDF'])->name('payslip.exportPDF');

Route::get('export-pdf/employee', [EmployeeController::class, 'exportPDF'])->name('employee.exportPDF');
...
Route::prefix('/device-attendanceemployee')->middleware(['auth', 'XSS'])->group(function () {
    Route::as('device-attendanceemployee.')->group(function () {
        ...
        Route::get('reports-monthly', [DeviceReportController::class, 'monthlyAttendance'])->name('report.monthly.attendance');
        //branch wise department get in attendance report
        Route::post('reports-monthly/getdepartment', [DeviceReportController::class, 'getdepartment'])->name('report.attendance.getdepartment');
